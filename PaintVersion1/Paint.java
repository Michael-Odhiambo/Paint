...
public class Paint extends Application {
     ...
     * ( The last color is a slightly darker version of yellow for better
     * visibility on a white background.)
     */
    ...
    /**
     * The main routine allows the class to be run as a program.
     */
    ...
    /**
     * The start() method creates the GUI, sets up event listening, and shows
     * the window on the screen.
     */
    public void start( Stage stage ) {

        /* Create the canvas and draw its contents for the first time.*/
    ...
    /**
     * Fills the canvas with white and draws the color palette and a simulated
    ...
    public void clearAndDrawPalette(){
        ...
        /**
         * The distance between the top of one colored rectangle in the palette
         * and the top of the rectangle below it. The height of the rectangle will
         * be colorSpacing - 3. There are 7 colored rectangles, so the available
         * space is divided by 7. The available space allows for the gray border and the
         * 50-by-50 CLEAR button.
         *
     ...
     * are three possibilities, depending on where the user clicked: Change the
     * current color, clear the drawing, or start drawing a curve. ( Or do nothing
     * if the user clicks on the border. )
     */
    public void mousePressed( MouseEvent evt ) {

        // Ignore mouse presses that occur when the user is already drawing
        // a curve. ( This can happen if the user presses two mouse buttons at the same
        // time. )
        if ( dragging == true )
            return;
        ...
        if ( x > width - 53 ) {
            ...
            // This click is either on the clear button or on the color palette.
            if ( y > height - 53 )
    ...
    /**
     * Called whenever the user releases the mouse button. Just sets dragging to false.
     */
    ...
    public void mouseDragged( MouseEvent evt ) {
        ...
        g.strokeLine( prevX, prevY, x, y );  // Draw the curve.
